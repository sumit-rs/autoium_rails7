json.extract! test_case, :id, :field_name, :field_type, :read_element, :input_value, :action, :action_url,
              :xpath, :full_xpath, :sleeps, :new_tab, :description, :need_screenshot, :enter_action, :custom_command_id, :javascript_conditional_enabled, :javascript_conditional, :selenium_file, :element_class
